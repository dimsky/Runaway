...
@interface Runaway : NSObject

@end

@implementation Runaway
...
CHConstructor // code block that runs immediately upon load
{
	@autoreleasepool
	{
		...
		// this would be posted using: notify_post("dimsky.Runaway.eventname");
		CFNotificationCenterRef darwin = CFNotificationCenterGetDarwinNotifyCenter();
		CFNotificationCenterAddObserver(darwin, NULL, ExternallyPostedNotification, CFSTR("dimsky.Runaway.eventname"), NULL, CFNotificationSuspensionBehaviorCoalesce);
